...
| Category | Skills |
| :--- | :--- |
| **Security** | CompTIA Security+, SIEM (Splunk/Elastic), Wireshark, Nmap, Metasploit, Linux (Kali/Ubuntu), Incident Response |
| **Scripting & Data** | **Python** (Automation, Forensics), **SQL** (Log Querying), Bash, Pandas, NumPy |
| **Platforms** | Git/GitHub, Docker, Azure (Basic), Virtualization |
